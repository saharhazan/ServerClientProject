...
public:
	...
	bool createNewUser(const SOCKET& socket, struct sockaddr_in* serverAddr, char* clientUuid) const;
	void updateUserInfo(FileHandler& fileOp, std::fstream& userFile, const std::string& userID, const Response& res, bool uuidFound) const;
